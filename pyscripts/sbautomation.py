"""
    __description__     = 'This SBAutomation Python Framework is designed to provide a user friendly and easy access of start and stop services for PLM based Teamcenter Modules.'
...
def main():
    ...
    parser.add_argument('--packageinfo', dest="packageinfo", default='sbautomation', choices = ['sbautomation'], help='Name of the package that should be called')
    ...
    try:
        if getattr(args, 'module'):
            ...
            printServices = PrintServices(args, extra_args)
            return_code = printServices.get_services_status()
            return return_code
